...
void main() {
  ...
  // -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
    ...
    outCd.a = max( vMinAlpha, outCd.a+biasToOne(depth*depth*depth)*.2 );
  ...
  // -- Consistent Night and Cave Darkness for Water --
  ...
  outCd.rgb *= mix(1.0, 1.0 - NightDarkness * 0.3, nightPhaseMod * skyBrightness);
  // -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
